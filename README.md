...
- [distilled_life_demo.md](examples/distilled_life_demo.md) / [distilled_life_demo.json](examples/distilled_life_demo.json) — 🧪 蒸馏人生
...
- **经验蒸馏**：蒸馏人生把 Life Story → Skill Asset → Eval Case，支持决策复盘、表达草稿和证据追踪
