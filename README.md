...
[![Version](https://img.shields.io/badge/version-1.3.3--beta-1E6B5B)](CHANGELOG.md)
...
仓库内置了五组**纯虚构、脱敏**的示例输出，覆盖全部 5 个 skill，方便你在 GitHub 上直接看成品：

- [past_life_demo.md](examples/past_life_demo.md) / [past_life_demo.json](examples/past_life_demo.json)
- [cringe_archaeology_demo.md](examples/cringe_archaeology_demo.md) / [cringe_archaeology_demo.json](examples/cringe_archaeology_demo.json)
- [ai_clone_demo.md](examples/ai_clone_demo.md) / [ai_clone_demo.json](examples/ai_clone_demo.json)
- [legacy_audit_demo.md](examples/legacy_audit_demo.md) / [legacy_audit_demo.json](examples/legacy_audit_demo.json)
- [epitaph_demo.md](examples/epitaph_demo.md) / [epitaph_demo.json](examples/epitaph_demo.json)
...
- v1.3.3-beta：项目级框架完整性检查 + 第二阶段优化（补齐 5 组示例、统一 prompt 纠正机制、增强验证脚本）
