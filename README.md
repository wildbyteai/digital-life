...
[![Version](https://img.shields.io/badge/version-1.5.3--beta-1E6B5B)](CHANGELOG.md)
...
Agent 会根据你提供的信息类型，自动选择最高效的数据获取路径。原则是**最小必要数据**：摘要 > 少量代表片段 > 脱敏导出文件 > 浏览器查看。不要粘贴密码、API key、身份证号、完整私人聊天记录、第三方秘密，或未经脱敏的医疗/法律/金融材料。
...
- **Browser 代操作**：用户已登录时，agent 可在用户确认范围后查看指定个人页面；优先最小必要数据，不默认批量抓取
